...
[the asset data model](../data-adapters/smintio-asset-data-model.md). For a worked, single-entity example built
against a real system, see the
[SharePoint connector walkthrough](Connector-SharePoint/README.md#meta-model-structure).
...
[the asset data model](../data-adapters/smintio-asset-data-model.md#user-content-say-what-you-support). Keep the two
...
together. See
[references between assets](../data-adapters/smintio-asset-data-model.md#user-content-references-between-assets).
...
hand; see
[filters are opaque tokens](../data-adapters/smintio-asset-data-model.md#user-content-filters-are-opaque-tokens).
