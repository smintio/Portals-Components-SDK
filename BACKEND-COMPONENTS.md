...
Current version of this document is: 2.4.0 (as of 14th of September, 2026)
...
1. [The connector meta-model: describing the external system's schema](connectors/smintio-connector-metamodel.md)
1. [The asset data model: what a data adapter returns](data-adapters/smintio-asset-data-model.md)
1. [Overview of Smint.io annotations](smintio-components/smintio-annotations.md)
...
- [Root directory](data-adapters/DataAdapter-HelloWorld/)
- [Test driver](data-adapters/Portals-HelloWorld-TestDriver)
...
- [Root directory](data-adapters/DataAdapter-SharePoint/)
- [Test driver README.md](data-adapters/Portals-Sharepoint-TestDriver/README.md)
...
- [Root directory](data-adapters/DataAdapter-Picturepark/)
- [Test driver](data-adapters/Portals-Picturepark-TestDriver/)

#### Root

- [Data adapter README.md](data-adapters/README.md)
...
The full list of supported Smint.io Portals annotations can be found [here](smintio-components/smintio-annotations.md).
...
**The full reference is [the connector meta-model](connectors/smintio-connector-metamodel.md)**: the data types, the
