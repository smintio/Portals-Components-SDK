...
[the connector meta-model](../connectors/smintio-connector-metamodel.md), covers the schema that gives those
...
[the frontend data adapter reference](../smintio-components/smintio-data-adapter-reference.md), which
...
[its meta-model](../connectors/smintio-connector-metamodel.md) — and anything you emit that the meta-model does
...
[connector meta-model](../connectors/smintio-connector-metamodel.md#user-content-form-groups--declaring-search-facets),
...
The [Hello World data adapter](DataAdapter-HelloWorld/) implements the shape of all
