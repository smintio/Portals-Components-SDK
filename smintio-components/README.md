...
1. [Overview of Smint.io UI components](smintio-ui-components.md)
1. [Overview of Smint.io page templates](smintio-page-templates.md)
1. [Overview of Smint.io mixins](smintio-mixins.md)
1. [Overview of Smint.io annotations](smintio-annotations.md)
1. [Overview of Smint.io frontend component types](smintio-frontend-component-types.md)
1. [Frontend reference: services, filters, property mixins, providers, CSS](smintio-frontend-reference.md)
1. [Data adapter reference: every public API interface and model](smintio-data-adapter-reference.md)
1. [Page type contracts: what a page hands to the components it hosts](smintio-page-type-contracts.md)
...
Current version of this document is: 1.3.0 (as of 14th of September, 2026)
...
[data adapter reference](smintio-data-adapter-reference.md) — including `IAssetDataObject`, the shape of an
...
Learn more about how to do that [here](https://github.com/smintio/Portals-Components-SDK/blob/main/BACKEND-COMPONENTS.md#user-content-custom-public-api-interfaces).
...
| Which frontend component type does it have? | which page template slots will accept it, and which page contract it can rely on — see [the frontend component types](smintio-frontend-component-types.md) | a type that does not exist cannot be invented on your side. If none of them fits, get in touch at [support@smint.io](mailto:support@smint.io) |

*Where it sits, and where its content comes from*

| Question | What it decides |
|---|---|
| Which portal types is it for, and which page does it go on? | whether you restrict it with `allowedPortalTypes`, and which contract applies — [what a page hands to the components it hosts](smintio-page-type-contracts.md) |
| Where does the content come from: the component's own configuration, a Smint.io data adapter, or a system of your own? | whether you work against the [data adapter public API interfaces](smintio-data-adapter-reference.md), or declare your own interface |
| Which existing component is the closest starting point — and is yours *that component plus something*, or something new? | how much you have to write, and whether you copy it or extend it. `ui-example-hello-world-1` is the minimal skeleton; the [overview of Smint.io UI components](smintio-ui-components.md) shows what already exists. An addition to an existing component should [extend it](#user-content-is-your-component-an-existing-one-plus-something-extend-it-do-not-copy-it) — a copy is a fork, and forks stop receiving later improvements to the component they came from |
| Which settings must the portal user be able to change, and which of them are advanced? | your configuration properties. Start with few — you can add options later, you cannot take them away. Text, link, colour and layout settings already exist as [mixins](smintio-mixins.md), so only ask for what those do not cover |
...
The full list of supported Smint.io Portals frontend component types can be seen [here](smintio-frontend-component-types.md).
...
The full list of supported Smint.io Portals annotations can be found [here](smintio-annotations.md).
...
[frontend reference](smintio-frontend-reference.md) splits the two lists; check which kind you are reaching
...
[mixin reference](smintio-frontend-reference.md) when you start a component, not after.
...
1. Check out the `page-templates` directory to find the implementations of our page templates
	...
	- Here you can find a list of our page template components (generated from our source, and kept current): https://github.com/smintio/Portals-Components-SDK/blob/main/smintio-components/smintio-page-templates.md
	
2. Check out the `ui-components` directory to find the implementations of our UI components

	- Here you can find a list of our UI components (generated from our source, and kept current): https://github.com/smintio/Portals-Components-SDK/blob/main/smintio-components/smintio-ui-components.md
